...
<html lang="en">
    <head>
        ...
        <title>Threads online | Manage Cancelled Orders</title>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Manage Cancelled Orders</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
                            <li class="breadcrumb-item active">Manage Cancelled Orders</li>
                        </ol>
                        <div class="card mb-4">
...
?>  
                                ...
                                <tr>
                                            ...
                                            <td style="color:green;"><?php echo htmlentities($row['orderStatus']);?></td>
                                            <td>
